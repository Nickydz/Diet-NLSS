...
public class notify_me_lunch extends Activity {
   ...
   */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button bt = (Button) findViewById(R.id.next2);
        bt.setOnClickListener(new View.OnClickListener() {
                                  @Override
                                  public void onClick(View v) {
                                      Intent i = new Intent(getApplicationContext(),notify_me_snack2.class);
                                      startActivity(i);
                                  }
                              }
        );
    ...
    private void initializeView(){
        edtTime = (EditText) findViewById(R.id.lch);
    ...
    public void timeOnClick(View view){
        new TimePickerDialog(notify_me_lunch.this,time, c.get(Calendar.HOUR_OF_DAY), c.get(Calendar.MINUTE), true).show();
    }
