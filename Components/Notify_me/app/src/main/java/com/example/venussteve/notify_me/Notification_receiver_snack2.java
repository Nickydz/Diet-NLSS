...
public class Notification_receiver_snack2 extends BroadcastReceiver {
    @Override
    public void onReceive(Context context, Intent intent) {
        ...
        Intent repeating_intent = new Intent(context, com.example.venussteve.notify_me.Repeating_activity_snack2.class);
